...
import 'package:gameblog/View/LatestNews/LatestNews_PostDetails.dart';
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                ...
                                child: InkWell(
                                    onTap: (){
                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => LatestNews_PostDetails(snapshot.data[index])));
                                    },
                                  child: Column(
                                    children: <Widget>[
                                      Container(
